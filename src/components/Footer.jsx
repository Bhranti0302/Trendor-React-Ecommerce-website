...
function Footer() {
  return (
    <footer className="mt-16">
      <div className="grid grid-cols-1 md:grid-cols-3 px-6 sm:px-12 md:px-20 lg:px-32 gap-10 text-center md:text-left">
        {/* Brand */}
      ...
      {/* Copyright */}
      <div className="mt-8 border-t border-stone-200 pt-4 text-center text-sm text-stone-500">
        © 2025 Bhranti Tamboli. All rights reserved.{" "}
        <strong>Do not copy or redistribute without permission.</strong>
      </div>
    </footer>
  );
}
